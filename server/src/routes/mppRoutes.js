...
router.post("/collection", protect, isAdmin, createMilkCollection);
...
// @access  Private/Admin
router.put("/collection/:id", protect, isAdmin, updateMilkCollection);

// @route   DELETE /api/mpp/collection/:id
// @desc    Delete a milk collection record
// @access  Private/Admin
router.delete("/collection/:id", protect, isAdmin, deleteMilkCollection);
