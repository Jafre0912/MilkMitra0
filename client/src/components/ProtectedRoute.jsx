...
const ProtectedRoute = ({ requiredRole }) => {
  ...
  if (isAdminRoute && userRole !== "admin") {
    toast.error(
      `Access denied. Admin permissions required. Your role: ${
        userRole || "none"
      }`
    );
  ...
  // Regular user route check - redirect admin users trying to access regular user dashboard to admin dashboard
  if (
    isRegularRoute &&
    userRole === "admin" &&
