      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-amber-800 flex items-center">
            <FaUserCog className="mr-2 text-amber-600" /> FarmFlow User
            Management
          </h1>
            ...
            <table className="min-w-full divide-y divide-amber-100">
              <thead className="bg-amber-50">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="px-6 py-3 text-center text-xs font-medium text-amber-700 uppercase tracking-wider"
                  >
                    Actions
                  </th>
                </tr>
              ...
              <tbody className="bg-white divide-y divide-amber-100">
                {filteredUsers.length === 0 ? (
                  <tr>
                    <td
                      colSpan="5"
                      className="px-6 py-4 text-center text-amber-500"
                    >
                      No users found
                    </td>
                  </tr>
