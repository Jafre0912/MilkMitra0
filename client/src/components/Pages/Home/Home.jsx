  ...
  return (
    <div className="bg-gradient-to-b pt-20 from-white to-green-50 overflow-hidden">
      ...
      <section className="relative pt-24 pb-20 overflow-visible">
        {/* Modern abstract shapes - reduced z-index */}
        <div
        ...
        <div
          className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-green-100 mix-blend-multiply filter blur-3xl opacity-40"
          style={{ zIndex: 1 }}
        ></div>
        ...
        <div className="container mx-auto px-6 relative" style={{ zIndex: 10 }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <img
              ...
              className="block w-auto h-auto min-h-[250px] max-h-[400px] object-contain rounded-3xl drop-shadow-2xl md:block hidden"
            />
          </div>
        </div>
      </section>
