      ...
      <form onSubmit={handleSubmit} className="p-5">
        ...
        <div className="mb-8 border-b border-gray-200 pb-5">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Fill in the details to get an AI-powered diagnosis
          </p>
        </div>
            ...
            {cattle.filter((c) => c.status === "active").length > 0 ? (
              <>
                ...
                <p className="mt-2 text-xs text-gray-600 flex items-start">
                  ...
                  <span>
                    Selecting a cattle will auto-fill some details below. You
                    can still modify them if needed.
                  </span>
                </p>
              </>
            ) : (
              <div className="text-sm text-gray-600 italic">
                No active cattle found. Please add a cattle record before
                proceeding.
              </div>
            )}
          </div>
          ...
          <div>
            ...
            >
              ...
              <p className="mt-2 text-xs text-gray-500">
                Select all applicable symptoms. Be as specific as possible for
                better results.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              {validationErrors.temperature ? (
                ...
                <p className="mt-2 text-xs text-gray-500">
                  Normal cattle temperature: 101-102.5°F
                </p>
              )}
            </div>
