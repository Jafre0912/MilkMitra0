...
const PredictionDetail = () => {
  ...
  // Check if prediction exists and has the result property
  if (error || !prediction || !prediction.result) {
    return (
      <div className="max-w-4xl mx-auto p-4 sm:p-6">
        <div className="bg-white rounded-lg shadow-sm border border-red-200 p-6">
          ...
          <p className="text-gray-600 mb-4">
            {error || "Prediction data is incomplete or not found"}
          </p>
          <button
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between">
            ...
            <div
              className={`flex items-center ${urgencyDisplay.bgColor} ${urgencyDisplay.borderColor} px-3 py-1 rounded-full border`}
            >
              {urgencyDisplay.icon}
              <span
                className={`ml-1 text-sm font-medium ${urgencyDisplay.color}`}
              >
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <div className="space-y-3">
            {prediction.result.possibleDiseases &&
