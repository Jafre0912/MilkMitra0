...
const DiseasePrediction = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      ...
      if (uploadedImage) {
        predictionData.image = uploadedImage;
      }
      ...
      if (result.success) {
        if (result.data) {
          if (result.data.age !== undefined && (typeof result.data.age !== 'object' || result.data.age === null)) {
            ...
            result.data.age = { value: ageValue, unit: ageUnit };
          ...
          {activeTab === "form" && (
            <>
              ...
              <div className="mb-6 bg-white p-4 rounded-lg shadow-md border border-gray-200">
                <h2 className="text-lg font-semibold text-gray-700 mb-2">Upload Image (Optional)</h2>
